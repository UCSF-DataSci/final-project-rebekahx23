# Manual Benchmark Summary (20260320T075048Z)
...
| dq-manual-complex-p50-pro-20260320T062506Z | complex | gemini-3.1-pro-preview | P50 | 1.0000 | 0.5032 | 0.6695 | 986665 | 2104 | 994315 | n/a |
...
| dq-manual-simple-p50-flash-20260320T062856Z | simple | gemini-3.1-flash-lite-preview | P50 | 0.9784 | 1.0000 | 0.9891 | 649875 | 2015 | 651890 | n/a |
| dq-manual-simple-p05-flash-20260320T063109Z | simple | gemini-2.5-flash | P05 | 0.9767 | 0.6709 | 0.7954 | 187834 | 2051 | 194245 | n/a |
| dq-manual-simple-p10-flash-20260320T063200Z | simple | gemini-2.5-flash | P10 | 0.9767 | 0.4073 | 0.5748 | 174435 | 3129 | 182071 | n/a |
| dq-manual-simple-p20-flash-20260320T063256Z | simple | gemini-2.5-flash | P20 | 0.9767 | 1.0000 | 0.9882 | 166855 | 2590 | 174255 | n/a |
| dq-manual-simple-p05-flash-20260320T063344Z | simple | gemini-2.5-flash | P05 | 0.9819 | 0.5079 | 0.6695 | 164364 | 1938 | 170929 | n/a |
| dq-manual-simple-p10-flash-20260320T063436Z | simple | gemini-2.5-flash | P10 | 0.9819 | 0.6723 | 0.7981 | 204963 | 2449 | 210626 | n/a |
| dq-manual-simple-p20-flash-20260320T063523Z | simple | gemini-2.5-flash | P20 | 0.9854 | 0.6715 | 0.7987 | 449291 | 3376 | 456360 | n/a |
| dq-manual-simple-p05-flash-20260320T063619Z | simple | gemini-2.5-flash | P05 | 0.9737 | 0.5052 | 0.6653 | 174453 | 4388 | 183657 | n/a |
| dq-manual-simple-p10-flash-20260320T063721Z | simple | gemini-2.5-flash | P10 | 0.9767 | 0.3400 | 0.5044 | 224510 | 3357 | 231825 | n/a |
| dq-manual-simple-p20-flash-20260320T063816Z | simple | gemini-2.5-flash | P20 | 0.9737 | 0.4067 | 0.5737 | 225893 | 3361 | 233554 | n/a |
| dq-manual-simple-p05-pro-20260320T063904Z | simple | gemini-2.5-pro | P05 | 0.9577 | 0.3405 | 0.5024 | 942202 | 2118 | 949248 | n/a |
| dq-manual-simple-p10-pro-20260320T064052Z | simple | gemini-2.5-pro | P10 | 0.9780 | 0.2536 | 0.4028 | 250979 | 1156 | 255414 | n/a |
| dq-manual-simple-p20-pro-20260320T064210Z | simple | gemini-2.5-pro | P20 | 0.9797 | 0.6762 | 0.8001 | 646751 | 1906 | 652777 | n/a |
...
| complex | gemini-3.1-pro-preview | P50 | 1 | 1.0000 | 0.5032 | 0.6695 | 994315.0 | n/a |
| simple | gemini-2.5-flash | P05 | 4 | 0.9780 | 0.5053 | 0.6579 | 169471.2 | n/a |
| simple | gemini-2.5-flash | P10 | 4 | 0.9783 | 0.4810 | 0.6357 | 311806.0 | n/a |
| simple | gemini-2.5-flash | P20 | 4 | 0.9780 | 0.6462 | 0.7569 | 287161.2 | n/a |
| simple | gemini-2.5-pro | P05 | 2 | 0.9687 | 0.2551 | 0.3958 | 637494.0 | n/a |
| simple | gemini-2.5-pro | P10 | 2 | 0.9780 | 0.4620 | 0.5992 | 602641.5 | n/a |
| simple | gemini-2.5-pro | P20 | 2 | 0.9806 | 0.6734 | 0.7984 | 652835.0 | n/a |
...
| simple | gemini-3.1-flash-lite-preview | P50 | 1 | 0.9784 | 1.0000 | 0.9891 | 651890.0 | n/a |
...
| complex | gemini-3.1-pro-preview | P20 | no | recall_plateau |
| simple | gemini-2.5-flash | P20 | yes | recall_plateau |
| simple | gemini-2.5-pro | P20 | yes | recall_plateau |
| simple | gemini-3-flash-preview | P05 | no | recall_plateau |
| simple | gemini-3.1-flash-lite-preview | P50 | no | recall_plateau |
...
- For complex issues with gemini-3.1-pro-preview: use P20.
- For simple issues with gemini-2.5-flash: use P20 (run P50 follow-up).
- For simple issues with gemini-2.5-pro: use P20 (run P50 follow-up).
- For simple issues with gemini-3-flash-preview: use P05.
- For simple issues with gemini-3.1-flash-lite-preview: use P50.
